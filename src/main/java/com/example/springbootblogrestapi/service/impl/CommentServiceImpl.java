...
public class CommentServiceImpl implements CommentService {
    ...
    private CommentDto mapToDTO(Comment comment){
        CommentDto commentDto=mapper.map(comment, CommentDto.class); //converting comment to commentDto
    ...
    private Comment mapToEntity(CommentDto commentDto){
        Comment comment=mapper.map(commentDto, Comment.class); //converting commentDto to comment
